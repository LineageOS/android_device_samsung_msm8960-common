...
ifeq ($(TARGET_NEED_DISABLE_VIDEO_SNAPSHOT),true)
    LOCAL_CFLAGS += -DDISABLE_VIDEO_SNAPSHOT
endif
...
ifeq ($(TARGET_NEED_CAF_HACK),true)
    LOCAL_CFLAGS += -DCAF_HACK
endif
...
ifeq ($(TARGET_NEED_NARDSHU_HACK),true)
    LOCAL_CFLAGS += -DNARDSHU_HACK
endif
