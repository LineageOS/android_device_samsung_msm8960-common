...
const static char * whiteList[] = {"com.android.camera2", "com.google.android.talk"};
const static int whiteListLen = 2;
#endif
                ...
                hw_device_t** device)
{
    ...
    //happen.
    static const int pid = android::IPCThreadState::selfOrNull()->getCallingPid();
    int rv = 0;
    int num_cameras = 0;
    int cameraid;
